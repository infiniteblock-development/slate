...
```shell
# You can also use wget
curl -X GET https://waas.inbl-dev.site/api/waas/v1/coins/-/currency \
  -H 'Accept: application/json' \
  -H 'x-api-key: API_KEY'
...
```java
URL obj = new URL("https://waas.inbl-dev.site/api/waas/v1/coins/-/currency");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
fetch('https://waas.inbl-dev.site/api/waas/v1/coins/-/currency',
{
  method: 'GET',
...
r = requests.get('https://waas.inbl-dev.site/api/waas/v1/coins/-/currency', headers = headers)
